				...
				<ul class="folio_list">
					<li>
						<div class="foli_img">
							...
							<img src="images/food/lianrongsu.jpg" alt="莲蓉酥" />
						</div>	
						<h3 class="style">莲蓉酥</h3>
						<p class="para">这是一道川菜中的保留家常菜，由鸡丁、干辣椒、花生米等炒制而成。</p>
						<h4><a  href="tian1.jsp">了解详情</a></h4>
					</li>
					<li>
						<div class="foli_img">
							<a href="details.jsp">
							...
							<img src="images/tiandian/pic2.jpg" alt="" />
						</div>	
					...
					<li>
						<div class="foli_img">
							...
							<img src="images/tiandian/pic3.jpg" alt="" />
						</div>						
					...
					<li>
						<div class="foli_img">
							...
							<img src="images/tiandian/pic4.jpg" alt="" />
						</div>						
				...
				<ul class="folio_list top">
					<li>
						<div class="foli_img">
							...
							<img src="images/tiandian/pic5.jpg" alt="" />
						</div>						
						 <h3 class="style">Nulla commodo erat</h3>
						 <p class="para">There are many variations of passages of Lorem Ipsum available,</p>
					...
					<li>
						<div class="foli_img">
							...
							<img src="images/tiandian/pic6.jpg" alt="" />
						</div>						
						 <h3 class="style">Morbi sit amet mauris</h3>
						 <p class="para">Lorem ipsum dolor sit amet, consectetur elit,EIUSMOD tempor,</p>
						 <h4><a href="details.jsp">Nulla accumsan</a></h4>
					...
					<li>
						<div class="foli_img">
							...
							<img src="images/tiandian/pic7.jpg" alt="" />
						</div>	
						 <h3 class="style">Integer facilisis</h3>
						<p class="para">There are many variations of passages of Lorem Ipsum available,</p>
						<h4><a href="details.jsp">Vestilum feliing</a></h4>
					...
					<li>
						<div class="foli_img">
							...
							<img src="images/tiandian/pic8.jpg" alt="" />
						</div>		
