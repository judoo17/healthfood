...
<div class="wrap">
 	<!-- start main_content -->
		<div class="details">
						<h3 class="style">鱼香肉丝做法</h3>
						<span>简介</span>
						<p class="para">至今都觉得做饭（还有烘焙）是件很有乐趣的事情，可以玩转食材，将他们变成可口佳肴，并且还掌管着家人的健康大业。做饭这个也是我们主妇一列要将之进行一辈子的事业，一定要做好做强大，那么就从鱼香肉丝这个必须会做的家常菜冠军开始吧。</p>
						<span>准备食材</span>
						<p class="para">
							<br>主料：猪腿肉 泡椒 胡萝卜 香醋</br>
							<br>姜 蒜 葱 水发木耳 白糖 老抽 生抽 盐 清汤</br></p>
						<div class="det-histore">
									<h3 class="style">步骤详解</h3>
									<div class="historey-lines">
										<ul>
											<li><span>第一步</span></li>
											<li><p class="para"><label>把里脊肉切成细丝，用生抽1汤匙，胡椒粉适量，料酒1汤匙，水淀粉1汤匙抓匀腌制10分钟。</p></li>
											<div class="clear"> </div>
										</ul>
									</div>
									<div class="historey-lines">
										<ul>
											<li><span>第二步</span></li>
											<li><p class="para"><label> 胡萝卜、青椒切丝。准备葱姜蒜丝。在微波容器中加入2汤匙植物油，加入姜蒜拌一下，放入微波炉高火1分钟。取出，加入肉丝拌匀。</p></li>
											<div class="clear"> </div>
										</ul>
									</div>
									<div class="historey-lines">
										<ul>
											<li><span>第三步</span></li>
											<li><p class="para"><label> 加入胡萝卜丝、青椒丝，加1汤匙蚝油，1汤匙豆瓣酱，1汤匙甜面酱，1汤匙醋，1/2汤匙白糖，搅拌均匀。</p></li>
											<div class="clear"> </div>
										</ul>
									</div>
									<div class="historey-lines">
										<ul>
											<li><span>第四步</span></li>
											<li><p class="para"><label>放入微波炉高火3分钟，盖子微微错开.取出，搅拌一下，撒上葱花，再放入微波炉高火3分钟即可。</p></li>
											<div class="clear"> </div>
										</ul>
									</div>
									<div class="clear"> </div>
