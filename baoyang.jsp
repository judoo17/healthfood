				...
				<ul class="folio_list">
					<li>
						<div class="foli_img">
							...
							<img src="images/jianshen/baoyang/pic1.jpg" alt="" />
						</div>	
					...
					<li>
						<div class="foli_img">
							...
							<img src="images/jianshen/baoyang/pic2.jpg" alt="" />
						</div>	
					...
					<li>
						<div class="foli_img">
							...
							<img src="images/jianshen/baoyang/pic3.jpg" alt="" />
						</div>						
					...
					<li>
						<div class="foli_img">
							...
							<img src="images/jianshen/baoyang/pic4.jpg" alt="" />
						</div>						
				...
				<ul class="folio_list top">
					<li>
						<div class="foli_img">
							...
							<img src="images/jianshen/baoyang/pic5.jpg" alt="" />
						</div>						
						 <h3 class="style">Nulla commodo erat</h3>
						 <p class="para">There are many variations of passages of Lorem Ipsum available,</p>
						<h4><a  href="details.jsp">Lorem ipsum</a></h4>
					...
					<li>
						<div class="foli_img">
							...
							<img src="images/jianshen/baoyang/pic6.jpg" alt="" />
						</div>						
						 <h3 class="style">Morbi sit amet mauris</h3>
						 <p class="para">Lorem ipsum dolor sit amet, consectetur elit,EIUSMOD tempor,</p>
						 <h4><a href="details.jsp">Nulla accumsan</a></h4>
					...
					<li>
						<div class="foli_img">
							...
							<img src="images/jianshen/baoyang/pic7.jpg" alt="" />
						</div>	
						 <h3 class="style">Integer facilisis</h3>
						<p class="para">There are many variations of passages of Lorem Ipsum available,</p>
						<h4><a href="details.jsp">Vestilum feliing</a></h4>
					...
					<li>
						<div class="foli_img">
							...
							<img src="images/jianshen/baoyang/pic8.jpg" alt="" />
						</div>		
						 <h3 class="style">Sed condimentum</h3>
						 <p class="para">Our website design and development provides quality web,</p>
						<h4><a  href="details.jsp">Lorem ipsum</a></h4>
	    ...
	    <div class="tsc_toggle_box">
			...
			<div class="gridis_of_4">
				...
				<div class="grid1_of_4">
					<h3>flickr widget</h3>
					<ul class="f_nav">
						<li><a href="#"><img src="images/jianshen/baoyang/f_pic1.jpg" alt=""> </a></li>
						<li><a href="#"><img src="images/jianshen/baoyang/f_pic2.jpg" alt=""> </a></li>
						<li><a href="#"><img src="images/jianshen/baoyang/f_pic3.jpg" alt=""> </a></li>
						<li><a href="#"><img src="images/jianshen/baoyang/f_pic4.jpg" alt=""> </a></li>
						<li><a href="#"><img src="images/jianshen/baoyang/f_pic5.jpg" alt=""> </a></li>
						<li><a href="#"><img src="images/jianshen/baoyang/f_pic6.jpg" alt=""> </a></li>
					</ul>
				</div>
				<div class="clear"></div>
		</div>
