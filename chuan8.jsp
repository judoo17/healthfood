...
<div class="wrap">
 	<!-- start main_content -->
		<div class="details">
						<h3 class="style">香辣虾做法</h3>
						<span>简介</span>
						<p class="para">香辣虾是一道汁浓、麻辣味浓，肉质紧韧爽脆的汉族名菜，属于渝派川菜。通常由虾、土豆、香芹、花生米等主料制作而成。</p>
						<span>准备食材</span>
						<p class="para">
							<br>主料：虾</br>
							<br>辅料：豆豉 料酒 葱 姜 蒜 花椒 老抽 花生油 食盐 冰糖 百合 枸杞</br></p>
						<div class="det-histore">
									<h3 class="style">步骤详解</h3>
									<div class="historey-lines">
										<ul>
											<li><span>第一步</span></li>
											<li><p class="para"><label>将虾处理好</p></li>
											<div class="clear"> </div>
										</ul>
									</div>
									<div class="historey-lines">
										<ul>
											<li><span>第二步</span></li>
											<li><p class="para"><label> 热锅倒入油，油温5分热下生姜和大蒜爆香,倒入虾反复煸炒至虾全部变色</p></li>
											<div class="clear"> </div>
										</ul>
									</div>
									<div class="historey-lines">
										<ul>
											<li><span>第三步</span></li>
											<li><p class="para"><label>把虾推向一边，加入一调羹郫县豆瓣酱煸炒出香味,加入料酒,加入干辣椒,倒入适量开水,倒入适量开水.</p></li>
											<div class="clear"> </div>
										</ul>
									</div>
									<div class="historey-lines">
										<ul>
											<li><span>第四步</span></li>
											<li><p class="para"><label>加入葱花后熄火撒上白芝麻，香菜即可上桌</p></li>
											<div class="clear"> </div>
										</ul>
									</div>
									<div class="clear"> </div>
