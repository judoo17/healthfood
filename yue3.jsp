...
<div class="wrap">
 	<!-- start main_content -->
		<div class="details">
						<h3 class="style">咖喱肠粉做法</h3>
						<span>简介</span>
						<p class="para">广东省特色美食，在广东有着不可撼动的地位</p>
						<span>准备食材</span>
						<p class="para">
							<br>主料：洋葱</br>
							<br>辅料：咖喱 葱 酱油</br></p>
						<div class="det-histore">
									...
									<div class="historey-lines">
										<ul>
											<li><span>第一步</span></li>
											<li><p class="para"><label>炒锅下油烧热，炒香洋葱,倒下肠粉与葱翻炒.</p></li>
											<div class="clear"> </div>
										</ul>
									</div>
									<div class="historey-lines">
										<ul>
											<li><span>第二步</span></li>
											<li><p class="para"><label> 咖喱用热开水溶化备用.</p></li>
											<div class="clear"> </div>
										</ul>
									</div>
									<div class="historey-lines">
										<ul>
											<li><span>第三步</span></li>
											<li><p class="para"><label>咖喱用热开水溶化备用.
									...
									<div class="historey-lines">
										<ul>
											<li><span>第四步</span></li>
											<li><p class="para"><label>倒下溶化好的咖喱水,小火慢慢翻炒至咖喱汁粘稠即可出锅。</p></li>
											<div class="clear"> </div>
										</ul>
									</div>
									<div class="clear"> </div>
