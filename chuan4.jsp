...
<div class="wrap">
 	<!-- start main_content -->
		<div class="details">
						<h3 class="style">东坡肘子做法</h3>
						<span>简介</span>
						<p class="para">东坡肘子是苏东坡亲手创制并秘传下来的一道传统名菜。它有着肥而不腻， 粑而不烂的特点，香气四溢，滋味尤佳，可谓是色香味形俱佳。
猪蹄膀营养很丰富，含较多的蛋白质，特别是含有大量的胶原蛋白质，和肉皮一样，是使皮肤丰满、润泽，强体增肥的食疗佳品，有人称其为“美容食品”。外宾赞颂它可列入世界名菜。</p>
						<span>准备食材</span>
						<p class="para">
							<br>猪肘</br>
							<br>冰糖 葱 姜 黄豆酱油 食盐 花椒 黄酒 植物油</br></p>
						<div class="det-histore">
									<h3 class="style">步骤详解</h3>
									<div class="historey-lines">
										<ul>
											<li><span>第一步</span></li>
											<li><p class="para"><label>准备好所用食材，肘子刮洗干净，也可以用火先烧表皮，然后刮洗，更干净；葱切段，姜切厚片拍破备用</p></li>
											<div class="clear"> </div>
										</ul>
									</div>
									<div class="historey-lines">
										<ul>
											<li><span>第二步</span></li>
											<li><p class="para"><label> 锅中放水，在骨头边的肉上划一刀煮，放点葱姜和花椒粒（这个葱姜与花椒是用量外的），煮大约15分钟捞出来稍凉剔去骨；起锅放入水和冰糖</p></li>
											<div class="clear"> </div>
										</ul>
									</div>
									<div class="historey-lines">
										<ul>
											<li><span>第三步</span></li>
											<li><p class="para"><label> 炒糖色(汁)：用一半冰糖炒糖色，炒好后加少许热水调开糖色倒碗中备用。剔出骨的肘子稍晾干水气后再用布擦一下，然后坐锅倒少许油，烧到七成热，把肉皮向下放进锅里中火把皮炸成金黄。</p></li>
											<div class="clear"> </div>
										</ul>
									</div>
									<div class="historey-lines">
										<ul>
											<li><span>第四步</span></li>
											<li><p class="para"><label>炸过后放盘中备用；砂锅下边垫竹篦子，以防粘锅。然后把葱段和拍破的姜分散放入，放花椒，倒黄酒，下另一半冰糖和炒好的糖色水、盐和酱油；最后把肘子皮朝下放进去。加入热水没过肘子，大火烧开转小火慢炖两个小时后再接着炖一个小时，汤汁浓稠，收汁即可</p></li>
											<div class="clear"> </div>
										</ul>
									</div>
									<div class="clear"> </div>
