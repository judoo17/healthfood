...
<div class="wrap">
 	<!-- start main_content -->
		<div class="details">
						<h3 class="style">芙蓉蟹做法</h3>
						<span>简介</span>
						<p class="para">芙蓉蟹，是一道闻名中外的特色传统名菜，属于粤菜系。芙蓉蟹选用蟹粉，蟹壳为主料，佐以蛋清、高汤、米醋等辅料烹制而成。成菜蟹肉黄白，状似芙蓉，味道嫩美，香味浓郁。</p>
						<span>准备食材</span>
						<p class="para">
							<br>主料：螃蟹</br>
							<br>辅料：鸡蛋 面粉 生姜 葱 芹菜 食盐 料酒</br></p>
						<div class="det-histore">
									<h3 class="style">步骤详解</h3>
									<div class="historey-lines">
										<ul>
											<li><span>第一步</span></li>
											<li><p class="para"><label>先将葱切葱花，生姜切小片，芹菜切成细末即可。</p></li>
											<div class="clear"> </div>
										</ul>
									</div>
									<div class="historey-lines">
										<ul>
											<li><span>第二步</span></li>
											<li><p class="para"><label> 将鸡蛋磕入碗中搅拌均匀，用两小勺的面粉兑水做个面糊备用，并处理螃蟹</p></li>
											<div class="clear"> </div>
										</ul>
									</div>
									<div class="historey-lines">
										<ul>
											<li><span>第三步</span></li>
											<li><p class="para"><label> 处理螃蟹，用剪刀剪下螃钳、蟹腿后，用刀背轻拍使蟹壳有点断裂，拍松即可。将螃蟹腮、内脏等清理干净。用刀将螃蟹一分为四即可。将处理好的螃蟹肉和蟹钳都轻裹上一层薄干面粉即可。油锅加热后，放入生姜片翻炒爆香。
									...
									<div class="historey-lines">
										<ul>
											<li><span>第四步</span></li>
											<li><p class="para"><label>将螃蟹放入油锅中煎炸，撒入葱花。淋上适量的料酒，加适量的水，水量没过螃蟹即可。等锅中水沸热后，加入少许的盐，倒入面糊，撒入芹菜末。14紧着将鸡蛋淋在螃蟹上，等蛋花稍凝固后轻轻翻动。</p></li>
											<div class="clear"> </div>
										</ul>
									</div>
									<div class="clear"> </div>
