...
.search button.btn {
    ...
    margin: 0px auto;
    margin: 1px;
    background: url(/Users/juedward/Desktop/hafweb/images/search_blue.png) no-repeat top right;
}
 	...
 	<!-- start main_content -->
				<ul class="folio_list">
					<c:forEach items="${applicationScope.menuList}" var="menu">
                           <li>
							<div class="foli_img">
								<img src="${manger}/upload/${menu.m_image}" alt="" />
							</div>	
							<h3 class="style">${manger}/${menu.style_cooking}</h3>
