...
<div class="wrap">
 	<!-- start main_content -->
		<div class="details">
						<h3 class="style">五花肉炒西兰花做法</h3>
						<span>简介</span>
						<p class="para">被人忽视的粤菜之一</p>
						<span>准备食材</span>
						<p class="para">
							<br>主料：五花肉 西兰花</br>
							<br>辅料：调和油 食盐 鸡精</br></p>
						<div class="det-histore">
									<h3 class="style">步骤详解</h3>
									<div class="historey-lines">
										<ul>
											<li><span>第一步</span></li>
											<li><p class="para"><label>选取肥中带瘦的五花肉。切成薄薄的片儿。放上点盐 酱油腌至着。</p></li>
											<div class="clear"> </div>
										</ul>
									</div>
									<div class="historey-lines">
										<ul>
											<li><span>第二步</span></li>
											<li><p class="para"><label> 将西兰花弄成小块，然后洗净后放入锅里焯水。</p></li>
											<div class="clear"> </div>
										</ul>
									</div>
									<div class="historey-lines">
										<ul>
											<li><span>第三步</span></li>
											<li><p class="para"><label>开火倒油，把五花肉放进去翻炒。等肉变色的时候，放上西兰花翻炒。
									...
									<div class="historey-lines">
										<ul>
											<li><span>第四步</span></li>
											<li><p class="para"><label>放上一小勺的盐。放点鸡精。继续大火翻炒。</p></li>
											<div class="clear"> </div>
										</ul>
									</div>
									<div class="clear"> </div>
